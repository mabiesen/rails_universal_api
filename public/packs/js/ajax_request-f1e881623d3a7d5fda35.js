...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/ajax_request.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/javascript/packs/ajax_request.js":
/*!**********************************************!*\
  !*** ./app/javascript/packs/ajax_request.js ***!
  \**********************************************/
...
/* WEBPACK VAR INJECTION */(function($) {document.addEventListener("turbolinks:load", function () {
  $("button.params_submit").on('click', function (event) {
    ...
    var $output = $('#output');
    var form_data = $('form').serialize(); // clear output box and let user know what we're doing

    $output.text("Fetching data. Time is " + new Date().toLocaleTimeString()); // no metter, either error or success, we print to the output box 
  ...
  $("input.param_input").on('keyup', function () {
    ...
    var param_data_hash = {};
    param_data_hash[input_name] = input_text; // form related detail

    var $urlpath_display = $('#urlpath_display');
    var $params_display = $('#params_display');
    var form_data = $('form').serialize(); // build urls
    ...
    var build_urlpath_url = '/build_urlpath/' + client_tag + '/' + request_name; // call to validate individual param, set border color
...
/******/ });
//# sourceMappingURL=ajax_request-f1e881623d3a7d5fda35.js.map