...
/* WEBPACK VAR INJECTION */(function($) {document.addEventListener("turbolinks:load", function () {
  $("button.params_submit").on('click', function () {
    var call_url = $(this).attr('data-callurl');
    var $output = $('#output');
    var form_data = $('form').serialize(); // no metter, either error or success, we print to the output box 
...
/******/ });
//# sourceMappingURL=ajax_request-44cfe824de173fdcb8cb.js.map